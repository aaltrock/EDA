...
mp_trn_func = "trainbr"; % Training function
...
min_hidden_layers = 10;
max_hidden_layer = 50;
run_nr = 5; % Number of runs to compare performance of varying hidden layer size
